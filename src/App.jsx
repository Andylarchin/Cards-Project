...
function App() {
  ...
  // const {data:UserData, error:userError,isLoading:userLoading} = useQuery('users', async () => {
  //   const values = [];
  ...
  // const {data:commentData, error:commentError,isLoading:commentLoading} = useQuery('comments',getComment)
  ...
  return (
    <>
       {/* <div class="bg">
       <Card PostsData={PostsData} UserData={UserData} commentData={commentData}/>
       </div> */}
       <LoginBody/>
    </>
  )
